	...
	<c:when test="${sessionScope.user.identity == 'admin'}">
		...
		<form action="${pageContext.request.contextPath }/AddScoreServlet" method="post">
			<table align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td height="30" align="right">学生编号</td>
					<td><input type="text" name="stuId"></td><span>${errerMsg}</span>
				</tr>
				<tr>
				...
				<tr>
					<td height="30" align="right">课程编号</td>
					<td><input type="text" name="courseId"></td>
				</tr>
				<tr>
					<td height="30" align="right">教师编号</td>
					<td><input type="text" name="tcId"></td>
				</tr>
				<tr>
					<td height="30" align="right">课程分数</td>
					<td><input type="text" name="courseGrade"></td>
				</tr>
				<tr>
					<td height="30" align="right">班级编号</td>
					<td><input type="text" name="classId"></td>
				</tr>
				<tr>
					<td height="30" colspan="2" align="center">
						<input type="submit" value="添加" class="ins"/> &nbsp;&nbsp;
